...
* You can now replicate to on-premises and other FSx for ONTAP systems using FSx for ONTAP as the source. 

+
link:https://docs.netapp.com/us-en/cloud-manager-fsx-ontap/use/task-manage-fsx-volumes.html#replicate-and-sync-data[Replicate and sync data]
...
* You can now  change the throughput capacity at any time after you create the FSx for ONTAP working environment.
+
link:https://docs.netapp.com/us-en/cloud-manager-fsx-ontap/use/task-manage-working-environment.html[Manage an Amazon FSx for ONTAP working environment]
