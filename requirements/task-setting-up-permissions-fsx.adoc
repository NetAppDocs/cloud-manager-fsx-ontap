---
sidebar: sidebar
permalink: start/task-setting-up-permissions-fsx.html
...
+
image:/media/screenshot_settings_icon.gif[A screenshot that shows the Settings icon in the upper right of the Cloud Manager console.]
